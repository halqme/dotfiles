...
- User asks "how do I make my React app faster?" → `bun x skills find react performance`
- User asks "can you help me with PR reviews?" → `bun x skills find pr review`
- User asks "I need to create a changelog" → `bun x skills find changelog`

The command will return results like:

```
Install with bun x skills add <owner/repo@skill>
...
To install it:
bun x skills add vercel-labs/agent-skills@vercel-react-best-practices
...
3. Suggest the user could create their own skill with `bun x skills init`
...
bun x skills init my-xyz-skill
```
